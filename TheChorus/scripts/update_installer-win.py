...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=TheChorus Demo Installer\n"
      else:
        line="OutputBaseFilename=TheChorus Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the TheChorus Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the TheChorus installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=TheChorus Demo installer\n"
     else:
       line="SetupWindowTitle=TheChorus installer\n"
