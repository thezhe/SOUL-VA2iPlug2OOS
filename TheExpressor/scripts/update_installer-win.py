...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=TheExpressor Demo Installer\n"
      else:
        line="OutputBaseFilename=TheExpressor Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the TheExpressor Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the TheExpressor installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=TheExpressor Demo installer\n"
     else:
       line="SetupWindowTitle=TheExpressor installer\n"
