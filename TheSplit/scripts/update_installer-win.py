...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=TheSplit Demo Installer\n"
      else:
        line="OutputBaseFilename=TheSplit Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the TheSplit Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the TheSplit installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=TheSplit Demo installer\n"
     else:
       line="SetupWindowTitle=TheSplit installer\n"
